...
namespace ERP.Infrastructure.Migrations
{
    ...
    [Migration("20260814064459_Add_HrmAdditionalEntities")]
    partial class Add_HrmAdditionalEntities
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("BaseEntity", t =>
                        {
                            t.Property("EmployeeId")
                                .HasColumnName("EmployeeDocument_EmployeeId");

                            t.Property("Notes")
                                .HasColumnName("EmployeeDocument_Notes");

                            t.Property("OrganizationId")
                                .HasColumnName("EmployeeDocument_OrganizationId");
                        });
                    ...
                    b.ToTable("BaseEntity", t =>
                        {
                            ...
                            t.Property("OrganizationId")
                                .HasColumnName("Holiday_OrganizationId");
                        });
                    ...
                    b.ToTable("BaseEntity", t =>
                        {
                            ...
                            t.Property("Year")
                                .HasColumnName("LeaveBalance_Year");
                        });
            ...
            modelBuilder.Entity("ERP.Domain.Hrm.Entities.LeaveEntitlement", b =>
                {
                    ...
                    b.ToTable("BaseEntity", t =>
                        {
                            t.Property("EmployeeId")
                                .HasColumnName("LeaveEntitlement_EmployeeId");

                            t.Property("LeaveType")
                                .HasColumnName("LeaveEntitlement_LeaveType");

                            t.Property("Notes")
                                .HasColumnName("LeaveEntitlement_Notes");

                            t.Property("OrganizationId")
                                .HasColumnName("LeaveEntitlement_OrganizationId");

                            t.Property("PendingDays")
                                .HasColumnName("LeaveEntitlement_PendingDays");

                            t.Property("TotalDays")
                                .HasColumnName("LeaveEntitlement_TotalDays");

                            t.Property("UsedDays")
                                .HasColumnName("LeaveEntitlement_UsedDays");

                            t.Property("Year")
                                .HasColumnName("LeaveEntitlement_Year");
                        });

                    b.HasDiscriminator().HasValue("LeaveEntitlement");
                });
            ...
            modelBuilder.Entity("ERP.Domain.Hrm.Entities.OvertimeRequest", b =>
                {
                    ...
                    b.ToTable("BaseEntity", t =>
                        {
                            t.Property("ApprovedAt")
                                .HasColumnName("OvertimeRequest_ApprovedAt");

                            t.Property("EmployeeId")
                                .HasColumnName("OvertimeRequest_EmployeeId");

                            t.Property("OrganizationId")
                                .HasColumnName("OvertimeRequest_OrganizationId");

                            t.Property("Reason")
                                .HasColumnName("OvertimeRequest_Reason");

                            t.Property("Status")
                                .HasColumnName("OvertimeRequest_Status");
                        });
            ...
            modelBuilder.Entity("ERP.Domain.Hrm.Entities.Payroll", b =>
                {
                    ...
                    b.ToTable("BaseEntity", t =>
                        {
                            t.Property("EmployeeId")
                                .HasColumnName("Payroll_EmployeeId");

                            t.Property("Notes")
                                .HasColumnName("Payroll_Notes");

                            t.Property("OrganizationId")
                                .HasColumnName("Payroll_OrganizationId");
            ...
            modelBuilder.Entity("ERP.Domain.Hrm.Entities.PayrollDetail", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("PayrollDetail");
                });
                    ...
                    b.ToTable("BaseEntity", t =>
                        {
                            ...
                            t.Property("IsActive")
                                .HasColumnName("Shift_IsActive");

                            t.Property("Name")
                                .HasColumnName("Shift_Name");

                            t.Property("OrganizationId")
                                .HasColumnName("Shift_OrganizationId");
                    ...
                    b.ToTable("BaseEntity", t =>
                        {
                            t.Property("ExpiryDate")
                                .HasColumnName("StockTransaction_ExpiryDate");
            ...
            modelBuilder.Entity("ERP.Domain.Sales.Entities.PaymentDetail", b =>
                {
                    ...
                    b.ToTable("BaseEntity", t =>
                        {
                            t.Property("Amount")
                                .HasColumnName("PaymentDetail_Amount");

                            t.Property("Notes")
                                .HasColumnName("PaymentDetail_Notes");

                            t.Property("PaymentDate")
                                .HasColumnName("PaymentDetail_PaymentDate");
