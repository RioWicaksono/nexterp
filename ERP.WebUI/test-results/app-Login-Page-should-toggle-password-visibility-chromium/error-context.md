...
- Name: app.spec.ts >> Login Page >> should toggle password visibility
...
Locator:  getByLabel(/Password/i).first()
Expected: "text"
Received: "password"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByLabel(/Password/i).first()
    13 × locator resolved to <input value="" id="password" type="password" placeholder="••••••••" class="↵                      w-full px-4 py-3 pr-12 rounded-xl border bg-white dark:bg-slate-900↵                      text-slate-800 dark:text-white placeholder:text-slate-400↵                      transition-all outline-none↵                      border-slate-200 dark:border-slate-700 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900↵                    "/>
