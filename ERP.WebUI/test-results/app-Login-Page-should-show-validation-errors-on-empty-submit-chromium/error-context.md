...
- Name: app.spec.ts >> Login Page >> should show validation errors on empty submit
...
Locator: getByText(/Username is required/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Username is required/i)
