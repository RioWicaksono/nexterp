...
- Name: app.spec.ts >> Register Page >> should show password requirements
- Location: e2e\app.spec.ts:134:7
...
Locator: getByText(/At least 8 characters/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/At least 8 characters/i)
